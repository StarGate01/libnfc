...
SET(LIBNFC_DRIVER_PN71XX_NCI ON CACHE BOOL "Enable PN71XX support (Depends on libnfc-nci)")
...
IF(LIBNFC_DRIVER_PN71XX_NCI)
  FIND_PACKAGE(NCI REQUIRED)
  ADD_DEFINITIONS("-DLIBNFC_DRIVER_PN71XX_NCI_ENABLED")
  SET(DRIVERS_SOURCES ${DRIVERS_SOURCES} "drivers/pn71xx")
  SET(NCI_REQUIRED TRUE)
ENDIF(LIBNFC_DRIVER_PN71XX_NCI)
